...
<div class="row form-group">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 row   ">
        ...
        <div class="col-md-6  col-sm-8 col-xs-10 row">
            <input type="text-inline" id="txt_razon_social_2" class="form-control"   placeholder="" pattern="[A-Za-z]{0,15}" required >
        </div>
...
<div class="row form-group">
    <div class="col-md-12 col-sm-12 col-xs-12 row ">
        ...
        <div class="col-md-6 col-sm-8 col-xs-10 row">
            <input type="text-inline" id="txt_giro_2" class="form-control"   placeholder="" pattern="[A-Za-z0-9]{0,15}" required >
        </div>
    </div>
...
<div class="row form-group">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 row ">
        ...
        <div class="col-md-6 col-sm-8 col-xs-10 row">
            <input type="text-inline" id="txt_fono_2" class="form-control"  onKeyPress="return numeros(event)" pattern="[0-9]{0,8}" required >
        </div>
    </div>
...
<div class="row form-group">
    <div class="col-md-12  col-sm-12 col-xs-12 row ">
        ...
        <div class="col-md-6 col-sm-8 col-xs-10 row">
            <input type="text-inline" id="txt_email_2" class="form-control"   placeholder="" pattern="^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required >
        </div>
    </div>
